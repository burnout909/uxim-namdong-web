...
export default async function ProductDetail({
    ...
    return (
        <div className="mx-auto max-w-5xl px-6 py-10">
            ...
            {/* 제목 */}
            <h1 className="text-3xl font-bold text-gray-900">생산품</h1>
            ...
            <div className="mt-6 flex items-center justify-end gap-2">
                <Link
                    href={prev ? `/notice/products/${prev.id}` : "#"}
                    aria-disabled={!prev}
                ...
                <Link
                    href={next ? `/notice/products/${next.id}` : "#"}
                    aria-disabled={!next}
